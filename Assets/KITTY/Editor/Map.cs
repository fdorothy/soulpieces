namespace KITTY {
	...
	internal struct Map {
		...
		///</summary>
		public Map(UnityEditor.AssetImporters.AssetImportContext context, TMX tmx) {
		...
		///</summary>
		static Tile[] ParseTilesets(UnityEditor.AssetImporters.AssetImportContext context, TSX[] tilesets, int tilewidth) {
		...
		///</summary>
		static Tileset ParseTileset(UnityEditor.AssetImporters.AssetImportContext context, TSX tsx) {
