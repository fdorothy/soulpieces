namespace KITTY {
	...
	[UnityEditor.AssetImporters.ScriptedImporter(1, "tmx", 2)]
	internal class TMXImporter : UnityEditor.AssetImporters.ScriptedImporter {
		///<summary>
		...
		///</summary>
		static GameObject CreateGrid(UnityEditor.AssetImporters.AssetImportContext context, Map map) {
		...
		///</summary>
		static GameObject[] CreateLayers(UnityEditor.AssetImporters.AssetImportContext context, Map map) {
