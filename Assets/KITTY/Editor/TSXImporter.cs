namespace KITTY {
	...
	///</summary>
	[UnityEditor.AssetImporters.ScriptedImporter(2, "tsx", 1)]
	internal class TSXImporter : UnityEditor.AssetImporters.ScriptedImporter {
		///<summary>
		///Loads and returns a Tileset asset, given a TSX structure.
		///</summary>
		public static Tileset Load(UnityEditor.AssetImporters.AssetImportContext context, TSX tsx) {
